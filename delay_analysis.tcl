...
proc test_multiplier {input_vector_arr size_arg} {
	set initial_state "";
	for {set iter 1} {$iter <= $size_arg} {incr iter} {
		set initial_state "$initial_state[return_x]";
	}
	foreach inp1 $input_vector_arr {
		...
		foreach inp2 $input_vector_arr {
			...
			setvector multiplicand $initial_state;
			setvector multiplier $initial_state;
			s;
			setvector multiplicand $layout_arg_1;
			setvector multiplier $layout_arg_2;
			s;
			path res0 res1 res2 res3 res4 res5 res6 res7;
		}
	}
}
